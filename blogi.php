...
//$date2=date("d.m.Y H:i:s", $date);	
		...
		?><tr><td><div style="border:1px solid #000;font-weight: bold;"><?php echo $row2["firstname"]." ".$row2["lastname"]." ". $date2 ?><br><p style="font-weight:normal"><?php echo $row2["kommentti"] ?></p></div></td></tr>
